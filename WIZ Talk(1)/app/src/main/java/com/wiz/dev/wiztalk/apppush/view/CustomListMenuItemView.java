 ...
 * @hide
 */
public class CustomListMenuItemView extends LinearLayout {
...
//    private int mMenuType;
    ...
    public CustomListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mContext = context;
    ...
    public CustomListMenuItemView(Context context, AttributeSet attrs) {
    ...
    public void initialize(boolean isVisible, CharSequence title, boolean shouldShowIcon, Drawable icon) {
...
//        final boolean showIcon = mItemData.shouldShowIcon() || mForceShowIcon;
        final boolean showIcon = shouldShowIcon || mForceShowIcon;
