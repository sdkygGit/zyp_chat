 ...
 */
package com.wiz.dev.wiztalk.adapter.base;
...
public class BaseAdapterHelper
{
	...
	/**
	 * universalImagerloader 通过universalImagerloader加载图片
	 * @param viewId
	 * @param uri 图片url
	 * @param options DisplayImageOptions universalImagerloader的参数.
	 * @return
	 */
	public BaseAdapterHelper setImageByUniversalImagerLoader(int viewId ,String uri,DisplayImageOptions options){
		ImageView view = retrieveView(viewId);
		ImageLoader.getInstance().displayImage(uri, view, options);
		return this;
	}
	/**
	 *  通过universalImagerloader加载图片,带监听器
	 * @param viewId
	 * @param uri  图片url
	 * @param options  DisplayImageOptions universalImagerloader的参数.
	 * @param listener ImageLoadingListener universalImagerloader的参数.
	 * @return
	 */
	public BaseAdapterHelper setImageByUniversalImagerLoader(int viewId ,String uri,DisplayImageOptions options,ImageLoadingListener listener){
		ImageView view = retrieveView(viewId);
