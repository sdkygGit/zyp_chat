package com.wiz.dev.wiztalk.download;
...
//        }
    ...
    public DownloadInfo getDownloadInfo(String clientMsgId) {
    	return map.get(clientMsgId);
    }
    public void addNewDownload(String clientMsgId, String url, String fileName, String target,
            boolean autoResume, boolean autoRename,
            final RequestCallBack<File> callback) {
    	DownloadInfo downloadInfo = this.addNewDownload(url, fileName, target, autoResume, autoRename, callback);
    	map.put(clientMsgId, downloadInfo);
    }
...
//        db.saveBindingId(downloadInfo);
    ...
    public DownloadInfo addNewDownload2(String url, String fileName, String target,
                                       boolean autoResume, boolean autoRename,
                                       final RequestCallBack<File> callback) /*throws DbException*/ {
        final DownloadInfo downloadInfo = new DownloadInfo();
        downloadInfo.setDownloadUrl(url);
