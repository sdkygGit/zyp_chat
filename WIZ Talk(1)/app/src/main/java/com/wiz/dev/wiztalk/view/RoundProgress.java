...
public class RoundProgress extends View {
    ...
    public RoundProgress(Context context, AttributeSet attrs, int defStyle) {
        ...
        textColor = mTypedArray.getColor(R.styleable.RoundProgress_progressTextColor, Color.GREEN);
        textSize = mTypedArray.getDimension(R.styleable.RoundProgress_progressTextSize, 15);
