...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context) {
		super(context);
		initColors(0xFF1B78D0, 0xFFCAE7FA, STYLE_FILL, STYLE_STROKE);
	}
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int activeDefaultColor = 0xFF1B78D0;
		...
		int inactiveDefaultColor = 0xFFCAE7FA;
		...
		// Retrieve the radius
		mRadius = a.getDimension(R.styleable.CircleFlowIndicator_radiusFN, 4.0f);
		...
		mCentered = a.getBoolean(R.styleable.CircleFlowIndicator_centeredFN, false);

		mSnap = a.getBoolean(R.styleable.CircleFlowIndicator_snapFN, false);
