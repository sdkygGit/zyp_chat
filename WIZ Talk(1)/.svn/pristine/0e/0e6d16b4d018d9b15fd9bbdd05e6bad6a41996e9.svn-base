...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int footerColor = a.getColor(R.styleable.TitleFlowIndicator_footerColorFN, FOOTER_COLOR);
		footerLineHeight = a.getDimension(R.styleable.TitleFlowIndicator_footerLineHeightFN, FOOTER_LINE_HEIGHT);
		footerTriangleHeight = a.getDimension(R.styleable.TitleFlowIndicator_footerTriangleHeight, FOOTER_TRIANGLE_HEIGHT);
		int selectedColor = a.getColor(R.styleable.TitleFlowIndicator_selectedColorFN, SELECTED_COLOR);
		boolean selectedBold = a.getBoolean(R.styleable.TitleFlowIndicator_selectedBoldFN, SELECTED_BOLD);
		...
		titlePadding = a.getDimension(R.styleable.TitleFlowIndicator_titlePaddingFN, TITLE_PADDING);
		clipPadding = a.getDimension(R.styleable.TitleFlowIndicator_clipPaddingFN, CLIP_PADDING);
